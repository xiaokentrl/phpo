...
func mockPayloads() map[string]any {
	...
	return map[string]any{
		...
		EventUpdateAvailable:     map[string]any{"version": "9.9.9", "changelog": "mock", "size": int64(42000000), "source": "github", "download_page": "https://github.com/xiaokentrl/phpo/releases"},
		EventUpdateProgress:      map[string]any{"stage": "download", "percent": 55, "speed": int64(1200000)},
