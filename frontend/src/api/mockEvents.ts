...
const MOCK_SAMPLES: Record<string, unknown> = {
  ...
  [EVENT.UpdateAvailable]: { version: '9.9.9', changelog: 'mock release', size: 42_000_000, source: 'github', download_page: 'https://github.com/xiaokentrl/phpo/releases' },
  [EVENT.UpdateProgress]: { stage: 'download', percent: 55, speed: 1_200_000 },
