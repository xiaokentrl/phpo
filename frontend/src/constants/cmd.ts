...
// 每项含 labelKey + kbd 提示，并按 route/action/layout 之一分发。
export type CmdAction = 'site-add' | 'backup' | 'theme' | 'doctor' | 'zoom-in' | 'zoom-out' | 'zoom-reset'
...
export const CMD_ITEMS: CmdItem[] = [
  ...
  { labelKey: 'cmd.doctor', kbd: '', action: 'doctor' },
